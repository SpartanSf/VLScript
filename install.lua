...
local function install()
    ...
    local manifestUrl = "https://raw.githubusercontent.com/SpartanSf/vlscript/master/manifest.txt"
    ...
    for i, step in ipairs(steps) do
        ...
        if step.type == "file" then
            ...
            local fileUrl = "https://raw.githubusercontent.com/SpartanSf/vlscript/master/" .. step.remote
